...
const TaskCard = ({task, id}:Props) => {
  ...
  return (
    <div ref={ref} className="w-full min-h-30 bg-white rounded-[14px] shadow-[0_1px_4px_rgba(0,0,0,0.06)] flex flex-col px-[1.5rem] py-[1rem] flex flex-col justify-between hover: cursor-grab transition-all duration-300 ease-in-out hover:-translate-y-1 hover:shadow-md">
      ...
      <div className="flex justify-between">
        ...
        <DeleteTaskButton className="border-none opacity-[0.5] transition-all duration-300 ease-in-out hover:opacity-[1] cursor-pointer" onClick={handleDelete}/>
      </div>
    </div>
  )
}
