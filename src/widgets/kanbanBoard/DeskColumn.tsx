...
const DeskColumn = ({status, id}: Props) => {
  ...
  return (
    <div ref={ref} className={`bg-deskcolumn w-1/3 min-h-100 px-[1rem] py-[1rem] rounded-[20px] border-[1.5px] border-dashed flex flex-col transition-all duration-200 ease-in-out ${isDropTarget ? 'border-[rgba(0,0,0,0.3)]' : 'border-[rgba(0,0,0,0.08)]'} `}>
